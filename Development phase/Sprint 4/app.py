...
def registet():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            TEXT = "Hello "+username + ",\n\n"+ """Thanks for applying registring at Customer Care """
            message  = 'Subject: {}\n\n{}'.format("Customer Care", TEXT)
            #sendmail(TEXT,email)
...
def apply():
     ...
     if request.method == 'POST' :
         ...
         session['loggedin'] = True
         TEXT = "Hello sujin,a new appliaction for job position" +jobs+"is requested"
         
         #sendmail(TEXT,"ssujin316@gmail.com.com")
         sendgridmail("ssujin316@gmail.com",TEXT)
